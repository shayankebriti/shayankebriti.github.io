...
<div class="pub-card">
  ...
  <div class="pub-body">
    ...
    <!-- (Text unchanged) -->
    <p class="pub-abstract">
      This ongoing work aims to develop a deep learning framework for anatomical mesh generation from raw medical images without requiring manual annotations. The framework consists of an anatomical structure <strong>segmentation network</strong>, <strong>a graph neural network for 3D mesh control-handle generation</strong>, and a <strong>deformation stage</strong> for final enhancments. The generated meshes are designed for use in in-silico simulations for mutliple modalities like CT and MR scans, enabling <strong>virtual experiments</strong> and <strong>computational modeling</strong> of anatomy for research, <strong>surgical planning</strong>, and <strong>medical device testing</strong>. More updates coming soon!
    </p>
  </div>
</div>
